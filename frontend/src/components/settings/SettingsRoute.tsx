...
import type {BlocklistDTO, CategoryDTO, DesktopIntegrationDTO, FeedDTO, FilterDTO, LimitsDTO, PeerLimitsDTO, QueueLimitsDTO, ScheduleRuleDTO, SeedingDefaultsDTO, ServerFlavor, TagDTO, UpdaterConfigDTO, UpdateInfoDTO, UserDTO, WebConfigDTO} from '../../lib/bindings';
      ...
      <div class="flex-1 overflow-auto">
        <Switch>
          ...
          <Match when={props.pane === 'connection'}>
            <ConnectionPane
              limits={props.limits}
              queueLimits={props.queueLimits}
              peerLimits={props.peerLimits}
          ...
          <Match when={props.pane === 'desktop'}>
            <DesktopPane
              desktopIntegration={props.desktopIntegration}
              onSetDesktopIntegration={props.onSetDesktopIntegration}
            />
          </Match>
