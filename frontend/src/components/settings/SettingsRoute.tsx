...
import type {BlocklistDTO, CategoryDTO, FeedDTO, FilterDTO, LimitsDTO, PeerLimitsDTO, QueueLimitsDTO, ScheduleRuleDTO, TagDTO, UpdaterConfigDTO, UpdateInfoDTO, WebConfigDTO} from '../../lib/bindings';
