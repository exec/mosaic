  ...
  return (
    <div class="inline-flex items-center gap-1.5">
      <input
        type="number"
        min={0}
        class="w-28 rounded border border-white/[.06] bg-black/30 px-2 py-1 text-right font-mono text-sm tabular-nums text-zinc-100 focus:border-accent-500/60 focus:outline-none focus:ring-2 focus:ring-accent-500/40"
        value={props.value || ''}
